...
function nomadtheme_setup() {
	...
	register_nav_menus(
		array(
			'top-menu' => esc_html__( 'Верхнее меню', 'nomadtheme' ),
			'main-menu' => esc_html__( 'Главное меню', 'nomadtheme' ),
			'footer-menu' => esc_html__( 'Меню подвала', 'nomadtheme' ),
		)
	);
...
function nomadtheme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'nomadtheme_content_width', 1280 );
}
